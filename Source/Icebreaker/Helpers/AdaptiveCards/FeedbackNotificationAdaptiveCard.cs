...
namespace Icebreaker.Helpers.AdaptiveCards
{
    ...
    /// </summary>
    public static class FeedbackNotificationAdaptiveCard
    {
        /// <summary>
        ...
        static FeedbackNotificationAdaptiveCard()
        {
            var cardJsonFilePath = HostingEnvironment.MapPath("~/Helpers/AdaptiveCards/FeedbackNotificationAdaptiveCard.json");
        ...
        public static string GetCard(string teamName, TeamsChannelAccount sender, TeamsChannelAccount recipient, string botDisplayName)
        {
            ...
            var FeedbackForm = Resources.FeedbackForm;
